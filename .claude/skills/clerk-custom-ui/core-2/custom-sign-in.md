...
> This document covers the **older SDK** (`@clerk/nextjs` v5–v6, `@clerk/clerk-react` v5–v6, `@clerk/clerk-expo` v1–v2).
> For the current SDK, see `core-3/custom-sign-in.md`.
...
export default function SignInPage() {
  ...
  return (
    <form onSubmit={handleSignIn}>
      <input type="email" value={identifier} onChange={(e) => setIdentifier(e.target.value)} placeholder="Email" />
