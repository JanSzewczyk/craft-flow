...
description:
  ...
  events. Build event-driven features like database sync, notifications, integrations.
...
**Organization Invitation**: `organizationInvitation.created` `organizationInvitation.accepted`
`organizationInvitation.revoked`

**Organization Membership**: `organizationMembership.created` `organizationMembership.updated`
