  ...
  return (
    <div className="bg-card border-border flex w-full flex-col gap-6 rounded-2xl border p-8 shadow-sm">
      <div className="flex flex-col gap-2 text-center">
        <h1 className="text-card-foreground text-2xl font-bold tracking-tight">Utwórz konto</h1>
        <p className="text-muted-foreground text-sm">Zarejestruj się i zacznij zarządzać swoim warsztatem.</p>
      </div>

      <button
        type="button"
        onClick={onGoogleSignUp}
        className="border-border bg-card hover:bg-accent text-card-foreground flex h-11 w-full cursor-pointer items-center justify-center gap-3 rounded-lg border px-4 text-sm font-medium transition-colors"
      >
